...
public class ReaderController {
	...
	public String findPaginatedReader(@PathVariable(value = "pageNumReader") int pageNumReader,
	...
	public String deleteCurso(@PathVariable(value = "memberNumber") long memberNumber) {
		this.readerService.deleteReaderById(memberNumber);
		return "redirect:/reader";
	}

	@GetMapping("/updateReader/{memberNumber}")
	public String showFormForUpdate(@PathVariable(value = "memberNumber") long memberNumber, Model model) {
