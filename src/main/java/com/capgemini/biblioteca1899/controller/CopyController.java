...
public class CopyController {
	...
	public String findPaginatedCopy(@PathVariable(value = "pageNumCopy") int pageNumCopy,
	...
	public String saveCopy(@ModelAttribute("copy") Copy copy) {
		copyService.saveCopy(copy);
		return "redirect:/copy";
	}

	@GetMapping("/deleteCopy/{copyId}")
	public String deleteCopy(@PathVariable(value = "copyId") long copyId) {
		this.copyService.deleteCopyById(copyId);
		return "redirect:/copy";
	}

	@GetMapping("/updateCopy/{copyId}")
	public String showFormForUpdate(@PathVariable(value = "copyId") long copyId, Model model) {
		Copy copy = copyService.getCopyById(copyId);
		model.addAttribute("copy", copy);
		return "/Copy/updateCopy";
	}

	@GetMapping("/newCopy/{idBook}")
